...
void CommandBuffer::ProcessCommands()
{
	while(m_Buffer.has_commands())
	{
		...
		switch(cmd)
		{
			...
			{
				GLenum target = m_Buffer.read<GLenum>();
				GLuint texture = m_Buffer.read<GLuint>();
			...
			{
				GLenum texture = m_Buffer.read<GLenum>();
			...
			{
				GLenum target = m_Buffer.read<GLenum>();
				GLuint buffer = m_Buffer.read<GLuint>();
			...
			case CommandId::GenBuffers:
			{
				GLsizei n = m_Buffer.read<GLsizei>();
				GLuint * buffers = m_Buffer.read<GLuint *>();
			...
			{
				GLuint program = m_Buffer.read<GLuint>();
				GLuint shader = m_Buffer.read<GLuint>();
			...
			{
				GLenum buffer = m_Buffer.read<GLenum>();
