...
namespace multigl
{
	...
	public:
		...
		void AttachShader(ShaderHandle program, ShaderHandle shader);
		...
		void ShaderSource(ShaderHandle shader, GLsizei count, const GLchar *const* string, const GLint * length);
		...
		void NamedFramebufferTexture(GLuint framebuffer, GLenum attachment, TextureHandle texture, GLint level);
		void NamedFramebufferTextureLayer(GLuint framebuffer, GLenum attachment, TextureHandle texture, GLint level, GLint layer);
		...
		void ClearNamedFramebufferiv(GLuint framebuffer, BufferHandle buffer, GLint drawbuffer, const GLint * value);
		void ClearNamedFramebufferuiv(GLuint framebuffer, BufferHandle buffer, GLint drawbuffer, const GLuint * value);
		void ClearNamedFramebufferfv(GLuint framebuffer, BufferHandle buffer, GLint drawbuffer, const GLfloat * value);
		void ClearNamedFramebufferfi(GLuint framebuffer, BufferHandle buffer, GLint drawbuffer, GLfloat depth, GLint stencil);
		...
		void VertexArrayElementBuffer(GLuint vaobj, BufferHandle buffer);
		void VertexArrayVertexBuffer(GLuint vaobj, GLuint bindingindex, BufferHandle buffer, GLintptr offset, GLsizei stride);
	...
	public:
		void ProcessCommands(ResourceManager& resourceManager);
